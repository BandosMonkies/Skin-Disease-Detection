...
import { Scan, Activity, Brain, Stethoscope, Shield } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    description: "Uses PyTorch model to detect skin type (oily, dry, normal) for personalized care recommendations.",
  },
];
